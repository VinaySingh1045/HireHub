...
import { getAllEmployerUsers, getAllJobSeekerUsers, getAllUsers, getPendingCompanies, getPendingJobs, updateCompanyStatus, updateJobStatus } from "../controllers/Admin.controller.js";
...
router.route("/getAllJobSeekerUsers").get(verifyJWT, isAdmin, getAllJobSeekerUsers)
